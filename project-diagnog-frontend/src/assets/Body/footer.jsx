    ...
    return ( 
        <div className="footer">
            <footer className="foot">
                <div className="diaglogo">
                    <h2>🎆 Welcome to Diagnog</h2>
                ...
                <div className="thirdfooter">
                    <div className="copyright">
                        <p> 2025 Diagnog. All rights reserved.</p>
                    </div>
                    <div className="terms">
                        <p>By using our website, you agree to our <a href="">Terms & Conditions</a>.</p>
                    </div>
