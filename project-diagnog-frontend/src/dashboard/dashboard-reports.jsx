...
const DashboardReports = () => {
  ...
  const [diagnosisResult, setDiagnosisResult] = useState({
    prediction: 'N/A',
    confidence: 'N/A',
    infoLink: "https://www.who.int/news-room/fact-sheets/detail/skin-conditions" 
  });
  ...
  useEffect(() => {
    ...
    axios.get(`http://localhost:8081/user/report/${userEmail}`)
      .then(res => {
        console.log("API response (patient report):", res.data);
    ...
    // Fetch Latest Prediction (Diagnosis Result)
      ...
      .then(res => {
        ...
        if (res.data) {
          setDiagnosisResult(prev => ({
            ...prev, 
            prediction: res.data.prediction || 'No recent prediction',
            confidence: res.data.confidence !== undefined && res.data.confidence !== null
  ...
  const formatDate = (dateString) => {
    // Handle null or undefined dateString for robustness
        ...
        <div style={styles.container}>
          <div style={styles.card}>
            ...
            <div style={styles.content}>
                ...
                <div style={{ ...styles.grid, ...styles.gridCols2 }}>
                  <div>
                    <div style={styles.imageUpload}>
                      ...
                      {/* Note: This `uploadedImage` is currently static from patientData. */}
              ...
              {/* Description (static from patientData) */}
              ...
              {/* Recommended Actions (static from patientData) */}
              ...
              {/* Medical History (dynamic from medicalHistory state) */}
